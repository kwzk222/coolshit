...
public class ModMenuIntegration implements ModMenuApi {
    ...
    public ConfigScreenFactory<?> getModConfigScreenFactory() {
        return parent -> {
            ...
            espSub.add(entryBuilder.startBooleanToggle(Text.literal("Debug Mode"), TutorialMod.CONFIG.espDebugMode).setTooltip(Text.literal("Draws a red tint/border around the overlay area")).setDefaultValue(true).setSaveConsumer(newValue -> {
